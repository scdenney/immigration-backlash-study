...
# Sync Setup Script for immigration-backlash-study
# Auto-generated by master-sync-setup.sh (manually corrected)
...
# Note: Glob patterns from .gitignore replaced with directory-level symlinks
SYNC_ITEMS=(
    "data/raw"
    "workshop"
    "dmp_ethics"
    "application"
    "surveys/config/credentials.json"
    "surveys/config/.env"
    "analysis/outputs"
    "admin/budget"
    "admin/ethics"
